...
int main(int argc, char **argv) {
    ...
    const int ELEMENT_NUM = 1000000000;
    ...
    MPI_Gather(sub_moving_averages, num_elements_per_proc, MPI_FLOAT, moving_averages, num_elements_per_proc, MPI_FLOAT, 0, MPI_COMM_WORLD);
